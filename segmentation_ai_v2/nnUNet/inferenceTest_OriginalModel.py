...
os.environ["nnUNet_results"] = r"C:\Users\PolDiaz\.totalsegmentator\nnunet\results"
...
# Inference execution
input_files = [[join(INPUT_FOLDER, f)] for f in os.listdir(INPUT_FOLDER)
...
print("Inference with ORIGINAL TotalSegmentator vertebrae model completed.")
